...
// Difficulty: Medium
// Approach: Recursively build the tree using preorder for the root and inorder to split left & right subtrees.
// Time: O(n) | Space: O(n)
...
public:
    ...
    TreeNode* buildTree(vector<int>& preorder, vector<int>& inorder) {
        ...
        TreeNode* root = solve(preorder, 0, n-1, inorder, 0, n-1, mp);
        return root;
    }
};
